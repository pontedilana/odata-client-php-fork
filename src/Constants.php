...
* @version   GIT: 0.1.0
*
* @see      https://www.microsoft.com/en-us/dynamics365/
*/
...
class Constants
{
    public const SDK_VERSION = '0.5.2';
    ...
    public const ODATA_NEXT_LINK = '@odata.id';
    public const ODATA_VALUE = 'value';
    public const ODATA_CONTEXT = '@odata.context';
